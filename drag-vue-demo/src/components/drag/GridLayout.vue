...
<script>
import Vue from 'vue'
import { bottom, compact, getLayoutItem, moveElement, validateLayout, cloneLayout, getAllCollisions } from '@/libs/drag/utils'
import { getBreakpointFromWidth, getColsFromBreakpoint, findOrGenerateResponsiveLayout } from '@/libs/drag/responsiveUtils'
  ...
  mounted () {
    ...
    this.$nextTick(function () {
      ...
      this.$nextTick(function () {
        ...
        on(window, 'resize', self.$lodash.debounce(self.onWindowResize, 100))
