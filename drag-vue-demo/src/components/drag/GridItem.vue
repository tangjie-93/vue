<template>
	...
	>
		<slot></slot>
    <div ref='dragItem' class="dragItem"></div>
		<span
...
<script>
import { setTopLeft, setTopRight, setTransformRtl, setTransform } from '@/libs/drag/utils'
import { getControlPosition, createCoreData } from '@/libs/drag/draggableUtils'
