...
*/
function funDrag (element, parentEle) {
  var params = {
    left: 0,
    top: 0,
    currentX: 0,
  ...
  element.onmousedown = function (event) {
    ...
    // 按下鼠标时的dom当前坐标
    params.currentX =
        event.clientX || event.pageX + document.documentElement.scrollX
    params.currentY =
        event.clientY || event.pageY + document.documentElement.scrollY
  }
